...
namespace StudyAndOrder.Core.Migrations
{
    ...
    [Migration("20260502170113_RemoveMaterialNumberAddMaterialRequired")]
    partial class RemoveMaterialNumberAddMaterialRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EquipmentOrderProducedMaterialLine", b =>
                {
                    b.Property<int>("EquipmentsId")
                        .HasColumnType("int");

                    b.Property<int>("ProducedMaterialLinesId")
                        .HasColumnType("int");

                    b.HasKey("EquipmentsId", "ProducedMaterialLinesId");

                    b.HasIndex("ProducedMaterialLinesId");

                    b.ToTable("EquipmentOrderProducedMaterialLine");
                });
            ...
            modelBuilder.Entity("EquipmentOrderProducedMaterialLine", b =>
                {
                    b.HasOne("StudyAndOrder.Core.Models.Equipment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Material", b =>
                {
                    b.Navigation("ProducedMaterialLines");
                });
